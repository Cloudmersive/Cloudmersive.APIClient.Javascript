...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cloudmersive.ConvertWebApi();
  });
  ...
  describe('ConvertWebApi', function() {
    ...
    describe('convertWebUrlToPdf_0', function() {
      it('should call convertWebUrlToPdf_0 successfully', function(done) {
        //uncomment below and update the code to test convertWebUrlToPdf_0
        //instance.convertWebUrlToPdf_0(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
