...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cloudmersive.InlineResponse2008Words();
  });
  ...
  describe('InlineResponse2008Words', function() {
    it('should create an instance of InlineResponse2008Words', function() {
      // uncomment below and update the code to test InlineResponse2008Words
      //var instane = new Cloudmersive.InlineResponse2008Words();
      //expect(instance).to.be.a(Cloudmersive.InlineResponse2008Words);
    });
