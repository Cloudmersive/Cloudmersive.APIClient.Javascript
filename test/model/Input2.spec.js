...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cloudmersive.Input2();
  });
  ...
  describe('Input2', function() {
    it('should create an instance of Input2', function() {
      // uncomment below and update the code to test Input2
      //var instane = new Cloudmersive.Input2();
      //expect(instance).to.be.a(Cloudmersive.Input2);
    });
