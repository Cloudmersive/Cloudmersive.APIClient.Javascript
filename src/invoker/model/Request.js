...
(function(root, factory) {
   ...
   * @alias module:invoker/model/Request
   * @class
   */
   ...
   * @param {module:invoker/model/Request} obj Optional instance to populate.
   * @return {module:invoker/model/Request} The populated <code>Request</code> instance.
   */
