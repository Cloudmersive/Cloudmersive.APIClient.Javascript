...
(function(root, factory) {
   ...
   * @alias module:invoker/model/Input2
   * @class
   */
   ...
   * @param {module:invoker/model/Input2} obj Optional instance to populate.
   * @return {module:invoker/model/Input2} The populated <code>Input2</code> instance.
   */
