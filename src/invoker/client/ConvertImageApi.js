...
(function(root, factory) {
   ...
   * @module invoker/client/ConvertImageApi
   * @version 1.2.1
   */

  /**
   * Constructs a new ConvertImageApi. 
   * @alias module:invoker/client/ConvertImageApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:invoker/client/ConvertImageApi~convertImageImageFormatConvertCallback
     ...
     * @param {module:invoker/client/ConvertImageApi~convertImageImageFormatConvertCallback} callback The callback function, accepting three arguments: error, data, response
