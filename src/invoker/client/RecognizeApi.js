...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['invoker/ApiClient', 'invoker/model/InlineResponse20016'], factory);
  ...
  /**
   * Recognize service.
   * @module invoker/client/RecognizeApi
   * @version 1.2.1
   */

  /**
   * Constructs a new RecognizeApi. 
   * @alias module:invoker/client/RecognizeApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:invoker/client/RecognizeApi~recognizeDescribeCallback
     * @param {String} error Error message, if any.
     * @param {module:invoker/model/InlineResponse20016} data The data returned by the service call.
     ...
     * @param {module:invoker/client/RecognizeApi~recognizeDescribeCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:invoker/model/InlineResponse20016}
     */
