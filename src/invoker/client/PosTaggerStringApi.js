...
(function(root, factory) {
   ...
   * @module invoker/client/PosTaggerStringApi
   * @version 1.2.1
   */

  /**
   * Constructs a new PosTaggerStringApi. 
   * @alias module:invoker/client/PosTaggerStringApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:invoker/client/PosTaggerStringApi~posTaggerStringPostCallback
     ...
     * @param {module:invoker/client/PosTaggerStringApi~posTaggerStringPostCallback} callback The callback function, accepting three arguments: error, data, response
