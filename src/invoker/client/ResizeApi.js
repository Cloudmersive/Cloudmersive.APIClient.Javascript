...
(function(root, factory) {
  ...
  /**
   * Resize service.
   * @module invoker/client/ResizeApi
   * @version 1.2.1
   */

  /**
   * Constructs a new ResizeApi. 
   * @alias module:invoker/client/ResizeApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:invoker/client/ResizeApi~resizePostCallback
     ...
     * @param {module:invoker/client/ResizeApi~resizePostCallback} callback The callback function, accepting three arguments: error, data, response
