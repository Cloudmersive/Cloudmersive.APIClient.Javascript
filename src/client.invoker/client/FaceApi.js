...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['client.invoker/ApiClient', 'client.invoker/client.model/InlineResponse20014'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../client.model/InlineResponse20014'));
  } else {
  ...
  /**
   * Face service.
   * @module client.invoker/client/FaceApi
   * @version 1.2.1
   */

  /**
   * Constructs a new FaceApi. 
   * @alias module:client.invoker/client/FaceApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:client.invoker/client/FaceApi~faceCropFirstCallback
     ...
     * @param {module:client.invoker/client/FaceApi~faceCropFirstCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:client.invoker/client/FaceApi~faceCropFirstRoundCallback
     * @param {String} error Error message, if any.
     * @param {File} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {File} imageFile Image file to perform the operation on.  Common file formats such as PNG, JPEG are supported.
     * @param {module:client.invoker/client/FaceApi~faceCropFirstRoundCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link File}
     */
     ...
     * @callback module:client.invoker/client/FaceApi~faceLocateCallback
     * @param {String} error Error message, if any.
     * @param {module:client.invoker/client.model/InlineResponse20014} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {File} imageFile Image file to perform the operation on.  Common file formats such as PNG, JPEG are supported.
     * @param {module:client.invoker/client/FaceApi~faceLocateCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:client.invoker/client.model/InlineResponse20014}
     */
