...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Cloudmersive.ConvertImageApi = factory(root.Cloudmersive.ApiClient);
  }
   ...
   * @module client.invoker/client/ConvertImageApi
   * @version 1.2.1
   */

  /**
   * Constructs a new ConvertImageApi. 
   * @alias module:client.invoker/client/ConvertImageApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:client.invoker/client/ConvertImageApi~convertImageImageFormatConvertCallback
     ...
     * @param {module:client.invoker/client/ConvertImageApi~convertImageImageFormatConvertCallback} callback The callback function, accepting three arguments: error, data, response
