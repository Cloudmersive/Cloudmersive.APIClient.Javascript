...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Cloudmersive.ResizeApi = factory(root.Cloudmersive.ApiClient);
  }
  ...
  /**
   * Resize service.
   * @module client.invoker/client/ResizeApi
   * @version 1.2.1
   */

  /**
   * Constructs a new ResizeApi. 
   * @alias module:client.invoker/client/ResizeApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:client.invoker/client/ResizeApi~resizePostCallback
     ...
     * @param {module:client.invoker/client/ResizeApi~resizePostCallback} callback The callback function, accepting three arguments: error, data, response
