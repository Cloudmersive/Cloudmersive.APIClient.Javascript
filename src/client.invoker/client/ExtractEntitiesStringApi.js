...
(function(root, factory) {
   ...
   * @module client.invoker/client/ExtractEntitiesStringApi
   * @version 1.2.1
   */

  /**
   * Constructs a new ExtractEntitiesStringApi. 
   * @alias module:client.invoker/client/ExtractEntitiesStringApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:client.invoker/client/ExtractEntitiesStringApi~extractEntitiesStringPostCallback
     ...
     * @param {module:client.invoker/client/ExtractEntitiesStringApi~extractEntitiesStringPostCallback} callback The callback function, accepting three arguments: error, data, response
