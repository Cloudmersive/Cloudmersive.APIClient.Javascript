...
(function(root, factory) {
  ...
  /**
   * ConvertData service.
   * @module client.invoker/client/ConvertDataApi
   * @version 1.2.1
   */

  /**
   * Constructs a new ConvertDataApi. 
   * @alias module:client.invoker/client/ConvertDataApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:client.invoker/client/ConvertDataApi~convertDataCsvToJsonCallback
     ...
     * @param {module:client.invoker/client/ConvertDataApi~convertDataCsvToJsonCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:client.invoker/client/ConvertDataApi~convertDataXmlToJsonCallback
     * @param {String} error Error message, if any.
     * @param {Object} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:client.invoker/client/ConvertDataApi~convertDataXmlToJsonCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Object}
     */
