...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Cloudmersive.ConvertDocumentApi = factory(root.Cloudmersive.ApiClient);
  }
   ...
   * @module client.invoker/client/ConvertDocumentApi
   * @version 1.2.1
   */

  /**
   * Constructs a new ConvertDocumentApi. 
   * @alias module:client.invoker/client/ConvertDocumentApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:client.invoker/client/ConvertDocumentApi~convertDocumentAutodetectToPdfCallback
     ...
     * @param {module:client.invoker/client/ConvertDocumentApi~convertDocumentAutodetectToPdfCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:client.invoker/client/ConvertDocumentApi~convertDocumentDocxToPdfCallback
     * @param {String} error Error message, if any.
     * @param {File} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {File} inputFile Input file to perform the operation on.
     * @param {module:client.invoker/client/ConvertDocumentApi~convertDocumentDocxToPdfCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link File}
     */
     ...
     * @callback module:client.invoker/client/ConvertDocumentApi~convertDocumentPptxToPdfCallback
     * @param {String} error Error message, if any.
     * @param {File} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {File} inputFile Input file to perform the operation on.
     * @param {module:client.invoker/client/ConvertDocumentApi~convertDocumentPptxToPdfCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link File}
     */
     ...
     * @callback module:client.invoker/client/ConvertDocumentApi~convertDocumentXlsxToCsvCallback
     * @param {String} error Error message, if any.
     * @param {File} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {File} inputFile Input file to perform the operation on.
     * @param {module:client.invoker/client/ConvertDocumentApi~convertDocumentXlsxToCsvCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link File}
     */
     ...
     * @callback module:client.invoker/client/ConvertDocumentApi~convertDocumentXlsxToPdfCallback
     * @param {String} error Error message, if any.
     * @param {File} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {File} inputFile Input file to perform the operation on.
     * @param {module:client.invoker/client/ConvertDocumentApi~convertDocumentXlsxToPdfCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link File}
     */
