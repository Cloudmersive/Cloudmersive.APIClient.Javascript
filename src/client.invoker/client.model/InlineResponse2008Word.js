...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Cloudmersive.InlineResponse2008Word = factory(root.Cloudmersive.ApiClient);
  }
  ...
  /**
   * The InlineResponse2008Word model module.
   * @module client.invoker/client.model/InlineResponse2008Word
   * @version 1.2.1
   */

  /**
   * Constructs a new <code>InlineResponse2008Word</code>.
   * Position of the word
   * @alias module:client.invoker/client.model/InlineResponse2008Word
   * @class
   */
  ...
  /**
   * Constructs a <code>InlineResponse2008Word</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:client.invoker/client.model/InlineResponse2008Word} obj Optional instance to populate.
   * @return {module:client.invoker/client.model/InlineResponse2008Word} The populated <code>InlineResponse2008Word</code> instance.
   */
