...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Cloudmersive.InlineResponse2009 = factory(root.Cloudmersive.ApiClient);
  }
   ...
   * @module client.invoker/client.model/InlineResponse2009
   * @version 1.2.1
   */
   ...
   * Spell check result
   * @alias module:client.invoker/client.model/InlineResponse2009
   * @class
   */
   ...
   * @param {module:client.invoker/client.model/InlineResponse2009} obj Optional instance to populate.
   * @return {module:client.invoker/client.model/InlineResponse2009} The populated <code>InlineResponse2009</code> instance.
   */
