...
(function(root, factory) {
   ...
   * @module client.invoker/client.model/Input
   * @version 1.2.1
   */
   ...
   * @alias module:client.invoker/client.model/Input
   * @class
   */
   ...
   * @param {module:client.invoker/client.model/Input} obj Optional instance to populate.
   * @return {module:client.invoker/client.model/Input} The populated <code>Input</code> instance.
   */
