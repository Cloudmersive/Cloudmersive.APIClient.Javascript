...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['client.invoker/ApiClient', 'client.invoker/client.model/InlineResponse20014Faces'], factory);
   ...
   * @module client.invoker/client.model/InlineResponse20014
   * @version 1.2.1
   */
   ...
   * @alias module:client.invoker/client.model/InlineResponse20014
   * @class
   */
   ...
   * @param {module:client.invoker/client.model/InlineResponse20014} obj Optional instance to populate.
   * @return {module:client.invoker/client.model/InlineResponse20014} The populated <code>InlineResponse20014</code> instance.
   */
   ...
   * @member {Array.<module:client.invoker/client.model/InlineResponse20014Faces>} Faces
   */
